...
**Next Step · Transformación digital**
...
| Macarena Ignacio  | Scrum Master           |
| Juan José Torres  | UX/UI Designer         |
| Facundo Maggio    | Product Analyst        |
| Tiago Nakasone    | Tech Lead              |
| Santiago Martínez | Tech Lead              |

### Sponsor / contacto de la organización

- **Nombre:** Sebastián Pensado
- **Cargo:** Gerente Comercial
- **Contacto:** [Spensado@iber.uy](mailto:Spensado@iber.uy)
...
```mermaid
flowchart TB
    DIR["Dirección"] --> GG["Gerente General"]
    GG --> GH["Jefatura de Gestión Humana"]
    GG --> OV["Jefatura de Operaciones y Ventas"]
    GG --> GC["Gerente Comercial"]
    GG --> MK["Jefatura de Marketing"]
    GG --> BA["Brand Ambassador"]
    GG --> GA["Gerencia de Administración"]

    OV --> ET["Encargados de tiendas"]
    ET --> CT["Colaboradores de tiendas"]

    GC --> JC["Jefatura de Compras"]
    JC --> AC["Asistente de Compras"]
    GC --> CL["Encargado Centro Logístico"]
    CL --> AD["Auxiliares Depósito"]

    MK --> AM["Asistentes Marketing"]
    BA --> AS["Asistentes"]
    GA --> AA["Asistentes de Administración"]
```

Estructura jerárquica equivalente:
...
- **Dirección**
  - **Gerente General**
    ...
    - Gerente Comercial
      ...
      - Encargado Centro Logístico
        - Auxiliares Depósito
    - Jefatura de Marketing
      - Asistentes Marketing
    - Brand Ambassador
      - Asistentes
...
*proveedores → compras/importación → centro logístico → distribución → locales y canales digitales → clientes.*
...
| Automatizar la generación de solicitudes de reposición entre el depósito central y los locales.               | % de reposiciones generadas mediante reglas automáticas               | \>90% del total de ordenes de reposición | 2027 Q1   |
...
| US-04  | Costos logísticos                 | Must                 | El control de costos es una necesidad explicita del negocio.                                         |
...
- Se identifica:
  ...
  - Falta de claridad la información para controlar, medir los costos y el desempeño.
